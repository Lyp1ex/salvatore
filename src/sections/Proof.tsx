        ...
        <div className="mb-5 grid gap-3 md:grid-cols-2">
          {site.proofQuotes.slice(0, 2).map((quote, index) => (
            <motion.article
              ...
              className="rounded-2xl border border-[rgba(212,176,93,.2)] bg-[rgba(10,12,16,.82)] p-4"
            >
          ...
          {site.proofPillars.map((item, index) => (
            ...
            >
              <Card className="h-full border-[rgba(212,176,93,.24)]">
                <div className="mb-3 h-px w-full bg-[linear-gradient(90deg,rgba(212,176,93,.38),rgba(124,140,158,.22),rgba(255,255,255,0))]" />
